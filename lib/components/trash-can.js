...
const { DragContext } = require('./drag-context');
...
function TrashCan(document) {
	...
	var dismiss = DomElem('div', {class: 'dismiss css-close-button', tooltip: 'Dismiss'});
	...
	updateItemCount(SessionSyncModel.getUndoListLength());
